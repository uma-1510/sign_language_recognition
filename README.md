...
This is a Python project that captures hand gesture images and trains a Convolutional Neural Network (CNN) to classify them into 10 gesture classes.

## Features
- Real-time hand gesture data capture.
...
Model currently supports 10 classes.
You can add more by modifying create_gesture_data.py and trainCNN.py.
